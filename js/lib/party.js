  ...
  return (() => {
    ...
    var e = {
              ...
              return (
                (e.prototype.evaluate = function (e) {
                  if (0 === this.keys.length)
                    throw new Error(
                      "Attempt to evaluate a spline with no keys.",
                    );
              ...
              return (
                ...
                (e.prototype.scale = function (t) {
                  return "number" == typeof t
                    ? new e(this.x * t, this.y * t, this.z * t)
                    : new e(this.x * t.x, this.y * t.y, this.z * t.z);
                }),
                (e.prototype.normalized = function () {
                  var t = this.magnitude();
                  return 0 !== t
                    ? this.scale(1 / t)
                    : new (e.bind.apply(e, i([void 0], this.xyz)))();
                }),
                ...
                (e.prototype.dot = function (e) {
                  return (
                    this.magnitude() *
                    e.magnitude() *
                    Math.cos(n.deg2rad * this.angle(e))
                  );
                }),
                (e.prototype.toString = function () {
                ...
                (e.from2dAngle = function (t) {
                  return new e(
                    Math.cos(t * n.deg2rad),
                    Math.sin(t * n.deg2rad),
                  );
                }),
                (e.zero = new e(0, 0, 0)),
                (e.one = new e(1, 1, 1)),
                    ...
                    o = this.scene.emitters.map(function (e) {
                      return [
                        "⭯: " +
                          (e.currentLoop + 1) +
                          "/" +
                          (e.options.loops >= 0 ? e.options.loops : "∞"),
                        "Σp: " + e.particles.length,
                        e.isExpired
                          ? "<i>expired</i>"
                          : "Σt: " + e.durationTimer.toFixed(3) + "s",
                      ].join(", ");
                    });
            ...
            u = (function () {
              function e(e) {
                ((this.particles = []),
                  ...
                  (this.options = s.overrideDefaults(
                    a.getDefaultEmitterOptions(),
                    null == e ? void 0 : e.emitterOptions,
                  )),
                  (this.emission = s.overrideDefaults(
                    a.getDefaultEmissionOptions(),
                    null == e ? void 0 : e.emissionOptions,
                  )),
                  (this.renderer = s.overrideDefaults(
                    a.getDefaultRendererOptions(),
                    null == e ? void 0 : e.rendererOptions,
                  )));
              }
              return (
                Object.defineProperty(e.prototype, "isExpired", {
                  get: function () {
                    return (
                      ...
                      this.currentLoop >= this.options.loops
                    );
                  },
                  enumerable: !1,
                  configurable: !0,
                ...
                (e.prototype.tick = function (e) {
                  if (
                    ...
                    for (
                      var t = 0, r = 0, i = this.emission.bursts;
                      r < i.length;
                      r++
                    ) {
                      var n = i[r];
                      if (
                        n.time <= this.durationTimer &&
                        !this.attemptedBurstIndices.includes(t)
                      ) {
                        for (
                          var s = o.evaluateVariation(n.count), a = 0;
                          a < s;
                          a++
                        )
                          this.emitParticle();
                  ...
                  ((e.lifetime -= t),
                    this.options.useGravity &&
                      (e.velocity = e.velocity.add(
                        i.Vector.up.scale(n.settings.gravity * t),
                      )),
                    (e.location = e.location.add(e.velocity.scale(t))));
                ...
                (e.prototype.emitParticle = function () {
                  var e = new c.Particle({
                    ...
                    lifetime: o.evaluateVariation(
                      this.emission.initialLifetime,
                    ),
                    velocity: i.Vector.from2dAngle(
                      o.evaluateVariation(this.emission.angle),
                    ).scale(o.evaluateVariation(this.emission.initialSpeed)),
                    size: o.evaluateVariation(this.emission.initialSize),
                    rotation: o.evaluateVariation(
        ...
        "./src/particles/options/emitterOptions.ts": (e, t, r) => {
          ...
          t.getDefaultEmitterOptions = function () {
            return {
              ...
              maxParticles: 300,
              despawningRules: [
                i.despawningRules.lifetime,
                i.despawningRules.bounds,
              ],
              modules: [],
            };
          };
        ...
        "./src/particles/options/index.ts": function (e, t, r) {
          ...
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            n(r("./src/particles/options/emitterOptions.ts"), t),
            n(r("./src/particles/options/emissionOptions.ts"), t),
            n(r("./src/particles/options/renderOptions.ts"), t));
        },
            ...
            c = (function () {
              function e() {
                ((this.elements = new Map()),
                  (this.light = new n.Vector(0, 0, 1)),
                  (this.enabled = !0),
                  (this.enabled =
                    !i.settings.respectReducedMotion ||
              ...
              return (
                ...
                (e.prototype.end = function () {
                  for (var e = this.elements.keys(), t = e.next(); !t.done; ) {
                    var r = t.value;
                    (this.renderedParticles.includes(r) ||
                      (this.elements.get(r).remove(), this.elements.delete(r)),
                      (t = e.next()));
                  }
                ...
                (e.prototype.renderParticle = function (e, t) {
                  if (this.enabled) {
                    var r = t.renderer,
                      i = this.elements.has(e.id)
                        ? this.elements.get(e.id)
                        : this.createParticleElement(e, r);
                    if (
                      (r.applyColor && r.applyColor(e.color, i),
                      r.applyOpacity && r.applyOpacity(e.opacity, i),
                      r.applyLighting)
                    ) {
                      var n = a.rotationToNormal(e.rotation).dot(this.light);
                      r.applyLighting(n, i);
                    }
                    (r.applyTransform && r.applyTransform(e, i),
                      this.renderedParticles.push(e.id));
                  }
                }),
                (e.prototype.createParticleElement = function (e, t) {
                  ...
                  return (
                    ...
                    this.elements.set(
                      e.id,
                      o.particleContainer.current.appendChild(r),
                    ),
                    r
                  );
                }),
            ...
            s = (function () {
              ...
              return (
                ...
                (e.prototype.scheduleTick = function () {
                  this.scheduledTickId = window.requestAnimationFrame(
                    this.tick,
                  );
                }),
                ...
                (e.prototype.tick = function (e) {
                  ...
                  try {
                    for (var r = 0; r < this.emitters.length; r++) {
                      ((o = this.emitters[r]).tick(t),
                        o.isExpired &&
                          o.canRemove &&
                          this.emitters.splice(r--, 1));
                    }
                  } catch (e) {
                    console.error(
        ...
        "./src/systems/modules.ts": (e, t, r) => {
                ...
                (e.prototype.build = function () {
                  ...
                  return function (t) {
                    o(
                      ...
                      e.driverKey,
                      (function (e, t, r) {
                        if ("object" == typeof e && "evaluate" in e)
                          return e.evaluate(t);
          ...
          function o(e, t, r, n) {
            if ((void 0 === n && (n = !1), n)) {
              ...
              if (void 0 === s)
                throw new Error(
                  "Unable to use relative chaining with key '" +
                    t +
          ...
          ((t.randomRange = o),
            ...
            (t.randomUnitVector = function () {
              var e = o(0, 2 * Math.PI),
                t = o(-1, 1);
              return new i.Vector(
                Math.sqrt(1 - t * t) * Math.cos(e),
                Math.sqrt(1 - t * t) * Math.sin(e),
                t,
              );
            }),
        ...
        "./src/systems/shapes.ts": (e, t, r) => {
          ...
          ((t.resolvableShapes = {
            ...
            roundedSquare:
              '<div style="height: 10px; width: 10px; border-radius: 3px;"></div>',
            roundedRectangle:
              '<div style="height: 6px; width: 10px; border-radius: 3px;"></div>',
        ...
        "./src/templates/index.ts": function (e, t, r) {
          ...
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            n(r("./src/templates/confetti.ts"), t),
            n(r("./src/templates/sparkles.ts"), t));
        },
        ...
        "./src/util/index.ts": function (e, t, r) {
          ...
          (Object.defineProperty(t, "__esModule", { value: !0 }),
            n(r("./src/util/config.ts"), t),
            n(r("./src/util/rotation.ts"), t),
            n(r("./src/util/rules.ts"), t),
            n(r("./src/util/lazy.ts"), t));
        },
          ...
          var r = (function () {
            ...
            return (
              Object.defineProperty(e.prototype, "current", {
                get: function () {
                  return (
                    this.exists(this.value) || (this.value = this.factory()),
                    this.value
                  );
                },
                enumerable: !1,
