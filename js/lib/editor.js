...
(function (J, ne) {
        ...
        ((s || r) &&
          ...
          (a || l) &&
            ...
            (e.scrollLeft =
              ...
              i +
              this.clientWidth / 2),
          (s || r || a || l) && !n && this.scrollIntoView(c));
      }),
  ...
  const y = {
    ...
    Xn = { LEFT: 0, WHEEL: 1, RIGHT: 2, BACKWARD: 3, FORWARD: 4 };
  function ye(n, e, t = "log", o, i = "color: inherit") {
      ...
      return (
        ...
        d <= 0 || d > e
          ? (r && (clearTimeout(r), (r = null)),
            ...
            (s = n.apply(o, i)),
            r || (o = i = null))
          : !r && t.trailing !== !1 && (r = setTimeout(l, d)),
        s
      );
    };
  }
  function Qn() {
    const n = { win: !1, mac: !1, x11: !1, linux: !1 },
      e = Object.keys(n).find(
  ...
  function nt(n, ...e) {
    ...
    if (N(n) && N(t))
      for (const o in t)
        N(t[o])
          ? (n[o] || Object.assign(n, { [o]: {} }), nt(n[o], t[o]))
          : Object.assign(n, { [o]: t[o] });
    return nt(n, ...e);
  }
  function it(n) {
    const e = Qn();
    return (
      (n = n
        ...
        .replace(/\+/gi, " + ")),
      e.mac
        ? (n = n.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥"))
        : (n = n.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN")),
      n
    );
  }
  function ei(n) {
  ...
  const Co = 650;
  function ge() {
    return window.matchMedia(`(max-width: ${Co}px)`).matches;
  }
  const rt =
    typeof window < "u" &&
    window.navigator &&
  ...
  class u {
    ...
    static findAllInputs(e) {
      return xo(e.querySelectorAll(u.allInputsSelector)).reduce(
        (t, o) =>
          u.isNativeInput(o) || u.containsOnlyInlineElements(o)
            ? [...t, o]
            : [...t, ...u.getDeepestBlockElements(o)],
        [],
      );
    }
    ...
    static containsOnlyInlineElements(e) {
      ...
      const o = (i) =>
        !u.blockElements.includes(i.tagName.toLowerCase()) &&
        Array.from(i.children).every(o);
      return Array.from(t.children).every(o);
    }
    static getDeepestBlockElements(e) {
      return u.containsOnlyInlineElements(e)
        ? [e]
        : Array.from(e.children).reduce(
            (t, o) => [...t, ...u.getDeepestBlockElements(o)],
            [],
          );
    }
    static getHolder(e) {
    ...
    static getNodeByOffset(e, t) {
      ...
      if (!i) return { node: null, offset: 0 };
      const a = i.textContent;
      if (a === null || a.length === 0) return { node: null, offset: 0 };
      const l = Math.min(t - o, a.length);
      return { node: i, offset: l };
    }
  }
  function si(n) {
    return !/[^\t\n\r ]/.test(n);
  ...
  const So = {
    ...
    Io = class ke {
      ...
      static setDictionary(e) {
        ke.currentDictionary = e;
      }
      static _t(e, t) {
        const o = ke.getNamespace(e);
        return !o || !o[t] ? t : o[t];
      }
      static getNamespace(e) {
        return e
          ...
          .reduce(
            ...
            ke.currentDictionary,
          );
      }
    };
  Io.currentDictionary = So;
  let H = Io;
  ...
  class Ee {
    ...
    on(e, t, o, i = !1) {
      const s = ni("l"),
        r = { id: s, element: e, eventType: t, handler: o, options: i };
    ...
    findAll(e, t, o) {
      ...
      return (
        e && t && o
          ? (i = s.filter((r) => r.eventType === t && r.handler === o))
          : e && t
            ? (i = s.filter((r) => r.eventType === t))
            : (i = s),
        i
      );
    }
  ...
  class b {
    ...
    static isSelectionAtEditor(e) {
      ...
      let o = null;
      return (
        t && t instanceof Element && (o = t.closest(`.${b.CSS.editorZone}`)),
    ...
    static get rect() {
      ...
      if (
        ...
        return (
          T("Method SelectionUtils.rangeCount is not supported", "warn"),
          o
        );
    ...
    findParentTag(e, t, o = 10) {
      ...
      return !i || !i.anchorNode || !i.focusNode
        ? null
        : ([i.anchorNode, i.focusNode].forEach((a) => {
            let l = o;
            for (
              ;
              l > 0 &&
  ...
  function ai(n, e) {
    ...
    return n.type === "attributes" && n.attributeName === "data-empty"
      ? !1
      : !!(
          e.contains(o) ||
          (t === "childList" &&
  ...
  const at = "redactor dom changed",
    _o = "block changed",
    Mo = "fake cursor is about to be toggled",
    Ao = "fake cursor have been set",
    xe = "editor mobile layout toggled";
  function lt(n, e) {
  ...
  function Lo(n, e) {
    return Object.entries(n).some(([t, o]) => e[t] && ii(e[t], o));
  }
  async function Po(n, e) {
    const o = (await n.save()).data,
      i = e.find((s) => s.name === n.name);
    return i !== void 0 && !lt(i, "export")
      ? []
      : e.reduce((s, r) => {
          if (!lt(r, "import") || r.toolbox === void 0) return s;
          const a = r.toolbox.filter((l) => {
            if (V(l) || l.icon === void 0) return !1;
            if (l.data !== void 0) {
              if (Lo(l.data, o)) return !1;
            } else if (r.name === n.name) return !1;
            return !0;
          });
          return (s.push({ ...r, toolbox: a }), s);
        }, []);
  }
  function No(n, e) {
    return n.mergeable
  ...
  var _ = ((n) => (
    ...
    te = ((n) => (
      (n.APPEND_CALLBACK = "appendCallback"),
      (n.RENDERED = "rendered"),
      (n.MOVED = "moved"),
      (n.UPDATED = "updated"),
      (n.REMOVED = "removed"),
  ...
  class R extends we {
    constructor(
      { id: e = ti(), data: t, tool: o, readOnly: i, tunesData: s },
      r,
    ) {
      (super(),
        (this.cachedInputs = []),
          ...
          (l || c
            ...
            : (d = !(
                ...
                a.every((p) => {
                  ...
                  return [...Array.from(g), ...Array.from(f), v].some(
                    (S) => (
                      u.isElement(S) || (S = S.parentElement),
        ...
        (this.blockAPI = new ee(this)),
        (this.tool = o),
        (this.toolInstance = o.create(t, this.blockAPI, i)),
        (this.tunes = o.tunes),
        this.composeTunes(s),
    ...
    set selected(e) {
      ...
      const t = e === !0 && b.isRangeInsideContainer(this.holder),
        o = e === !1 && b.isFakeCursorInsideContainer(this.holder);
      (t || o) &&
        ((i = this.editorEventBus) == null || i.emit(Mo, { state: e }),
        t ? b.addFakeCursor() : b.removeFakeCursor(this.holder),
        (s = this.editorEventBus) == null || s.emit(Ao, { state: e }));
    }
    get selected() {
      ...
      return Promise.resolve(e)
        .then(
          (s) => (
            ...
            { id: this.id, tool: this.name, data: s, tunes: t, time: i - o }
          ),
        )
        .catch((s) => {
          T(
    ...
    updateCurrentInput() {
      this.currentInput =
        u.isNativeInput(document.activeElement) || !b.anchorNode
    ...
    async getActiveToolboxEntry() {
      ...
      const t = await this.data,
        o = e;
      return o == null ? void 0 : o.find((i) => Lo(i.data, t));
    }
    async exportDataAsString() {
      const e = await this.data;
      return li(e, this.tool.conversionConfig);
    }
    compose() {
    ...
    addInputEvents() {
      this.inputs.forEach((e) => {
        (e.addEventListener("focus", this.handleFocus),
          u.isNativeInput(e) && e.addEventListener("input", this.didMutated));
      });
    }
    removeInputEvents() {
      this.inputs.forEach((e) => {
    ...
    watchBlockMutations() {
      ...
      ((this.redactorDomChangedCallback = (t) => {
        const { mutations: o } = t;
        o.some((s) => ai(s, this.toolRenderedElement)) && this.didMutated(o);
      }),
        (e = this.editorEventBus) == null ||
          e.on(at, this.redactorDomChangedCallback));
    }
    unwatchBlockMutations() {
      var e;
      (e = this.editorEventBus) == null ||
        e.off(at, this.redactorDomChangedCallback);
    }
  ...
  class ci extends E {
        ...
        (this.convert = async (e, t, o) => {
          ...
          const c =
              ((h = a == null ? void 0 : a.conversionConfig) == null
                ...
                : h.export) !== void 0,
            d =
              ((p = l.conversionConfig) == null ? void 0 : p.import) !== void 0;
          if (c && d) {
            const g = await i.convert(r, t, o);
            return new ee(g);
          } else {
            const g = [c ? !1 : Le(r.name), d ? !1 : Le(t)]
              .filter(Boolean)
              .join(" and ");
            throw new Error(
              `Conversion from "${r.name}" to "${t}" is not possible. ${g} tool(s) should provide a "conversionConfig"`,
            );
          }
        }),
        (this.insertMany = (
          ...
          const o = e.map(({ id: i, type: s, data: r }) =>
          ...
          return (
            this.Editor.BlockManager.insertMany(o, t),
            o.map((i) => new ee(i))
          );
        }));
    }
    ...
    stretchBlock(e, t = !0) {
      st(!0, "blocks.stretchBlock()", "BlockAPI");
  ...
  function di(n, e) {
    return typeof n == "number"
      ? e.BlockManager.getBlockByIndex(n)
      : typeof n == "string"
        ? e.BlockManager.getBlockById(n)
        : e.BlockManager.getBlockById(n.id);
  }
  class ui extends E {
    constructor() {
      (super(...arguments),
        ...
        (this.setToBlock = (
          ...
          const i = di(e, this.Editor);
          return i === void 0
            ? !1
            : (this.Editor.Caret.setToBlock(i, t, o), !0);
        }),
        (this.focus = (e = !1) =>
          e
    ...
    (function (t, o) {
      ...
      return (function (t) {
        ...
        return (
          ...
          (i.d = function (s, r, a) {
            i.o(s, r) ||
              Object.defineProperty(s, r, { enumerable: !0, get: a });
          }),
          (i.r = function (s) {
            (typeof Symbol < "u" &&
              Symbol.toStringTag &&
          ...
          function f(k, m) {
            for (var w = 0; w < k.length; w++) {
              ...
              if (I) {
                ...
                for (; C < x.parts.length; C++) I.parts.push(j(x.parts[C], m));
              } else {
                var D = [];
                for (C = 0; C < x.parts.length; C++) D.push(j(x.parts[C], m));
                a[x.id] = { id: x.id, refs: 1, parts: D };
              }
            }
          }
          function v(k, m) {
            for (var w = [], x = {}, I = 0; I < k.length; I++) {
              var C = k[I],
                D = m.base ? C[0] + m.base : C[0],
                B = { css: C[1], media: C[2], sourceMap: C[3] };
              x[D]
                ? x[D].parts.push(B)
                : w.push((x[D] = { id: D, parts: [B] }));
            }
            return w;
          }
          function O(k, m) {
            ...
            if (k.insertAt === "top")
              (x
                ? x.nextSibling
                  ? w.insertBefore(m, x.nextSibling)
                  : w.appendChild(m)
...
`);
          ...
          function A(k) {
            ...
            return (
              k.attrs.type === void 0 && (k.attrs.type = "text/css"),
              G(m, k.attrs),
              O(k, m),
              m
            );
          ...
          function j(k, m) {
            ...
            if (m.singleton) {
              var D = h++;
              ((w = d || (d = A(m))),
                (x = he.bind(null, w, D, !1)),
                (I = he.bind(null, w, D, !0)));
            } else
              k.sourceMap &&
              typeof URL == "function" &&
              ...
              typeof btoa == "function"
                ? ((w = (function (B) {
                  ...
                  (x = function (B, K, Oe) {
                    var pe = Oe.css,
                      vo = Oe.sourceMap,
                      Ca = K.convertToAbsoluteUrls === void 0 && vo;
                    ((K.convertToAbsoluteUrls || Ca) && (pe = g(pe)),
                      vo &&
                        (pe +=
                          `
/*# sourceMappingURL=data:application/json;base64,` +
                          btoa(
                            unescape(encodeURIComponent(JSON.stringify(vo))),
                          ) +
                          " */"));
                    var Ta = new Blob([pe], { type: "text/css" }),
                      $n = B.href;
                    ((B.href = URL.createObjectURL(Ta)),
                      $n && URL.revokeObjectURL($n));
                  }.bind(null, w, m)),
                  (I = function () {
                    (S(w), w.href && URL.revokeObjectURL(w.href));
                  }))
                : ((w = A(m)),
                  (x = function (B, K) {
                    var Oe = K.css,
                      pe = K.media;
                    if ((pe && B.setAttribute("media", pe), B.styleSheet))
                      B.styleSheet.cssText = Oe;
                    else {
          ...
          t.exports = function (k, m) {
            ...
            (((m = m || {}).attrs = typeof m.attrs == "object" ? m.attrs : {}),
              m.singleton ||
                typeof m.singleton == "boolean" ||
                (m.singleton = l()),
              m.insertInto || (m.insertInto = "head"),
              m.insertAt || (m.insertAt = "bottom"));
            var w = v(k, m);
            return (
              f(w, m),
              function (x) {
                ...
                for (x && f(v(x, m), m), C = 0; C < I.length; C++) {
                  var B;
                  if ((B = I[C]).refs === 0) {
                    for (var K = 0; K < B.parts.length; K++) B.parts[K]();
                    delete a[B.id];
                  }
                }
              }
...
`)
          ...
          function he(k, m, w, x) {
            var I = w ? "" : x.css;
            if (k.styleSheet) k.styleSheet.cssText = oe(m, I);
            else {
              var C = document.createTextNode(I),
                D = k.childNodes;
              (D[m] && k.removeChild(D[m]),
                D.length ? k.insertBefore(C, D[m]) : k.appendChild(C));
            }
          }
        },
        function (t, o) {
          ...
          t.exports =
            ...
            (p = "cdx-notify__btns-wrapper"),
            {
              alert: (g = function (f) {
                ...
                return (
                  v.classList.add(r),
                  A && v.classList.add(r + "--" + A),
                  (v.innerHTML = S),
                  O.classList.add(a),
                  O.addEventListener("click", v.remove.bind(v)),
                  v.appendChild(O),
                  v
                );
              }),
              confirm: function (f) {
                ...
                return (
                  O.classList.add(p),
                  (S.innerHTML = f.okText || "Confirm"),
                  (A.innerHTML = f.cancelText || "Cancel"),
                  S.classList.add(h),
                  A.classList.add(h),
                  S.classList.add(l),
                  A.classList.add(c),
                  ...
                  U && typeof U == "function" && S.addEventListener("click", U),
                  S.addEventListener("click", v.remove.bind(v)),
                  A.addEventListener("click", v.remove.bind(v)),
                  O.appendChild(S),
                  O.appendChild(A),
                  v.appendChild(O),
                  v
              ...
              prompt: function (f) {
                ...
                return (
                  O.classList.add(p),
                  (S.innerHTML = f.okText || "Ok"),
                  S.classList.add(h),
                  S.classList.add(l),
                  A.classList.add(d),
                  f.placeholder && A.setAttribute("placeholder", f.placeholder),
                  f.default && (A.value = f.default),
                  f.inputType && (A.type = f.inputType),
                  j && typeof j == "function" && G.addEventListener("click", j),
                  U &&
                    typeof U == "function" &&
  ...
  class ki extends E {
    constructor({ config: e, eventsDispatcher: t }) {
      (super({ config: e, eventsDispatcher: t }), (this.notifier = new vi()));
    }
    get methods() {
          ...
          if (f)
            do {
              if (f.nodeType === Node.TEXT_NODE)
                if (
                  f.data.trim() === "" &&
                  ((f.previousElementSibling && i(f.previousElementSibling)) ||
                    (f.nextElementSibling && i(f.nextElementSibling)))
                ) {
              ...
              var S = !!p.parentNode,
                ...
                j = l(this.config, G, f),
                U = v && O;
              if (U || c(f, j) || (!this.config.keepNestedBlockElements && A)) {
              ...
              for (var oe = 0; oe < f.attributes.length; oe += 1) {
                var he = f.attributes[oe];
                d(he, j, f) && (f.removeAttribute(he.name), (oe = oe - 1));
              }
              this._sanitize(h, f);
  ...
  function dt(n, e) {
    return n.map((t) => {
      ...
      return (V(o) || (t.data = ut(t.data, o)), t);
    });
  }
  function q(n, e = {}) {
    const t = { tags: e };
    return new Ei(t).clean(n);
  }
  function ut(n, e) {
    return Array.isArray(n) ? xi(n, e) : N(n) ? Bi(n, e) : Q(n) ? Ci(n, e) : n;
  }
  function xi(n, e) {
    return n.map((t) => ut(t, e));
  }
  function Bi(n, e) {
    const t = {};
    for (const o in n) {
          ...
          class s {
            ...
            placeBottom(a, l) {
              const c = a.getBoundingClientRect(),
                ...
                h =
                  c.bottom + window.pageYOffset + this.offsetTop + l.marginTop;
  ...
  function Ho(n, e) {
    ...
    return (
      Object.entries(n).forEach(([o, i]) => {
        if (N(i)) {
          const s = e ? `${e}.${o}` : o;
          Object.values(i).every((a) => Q(a)) ? (t[o] = s) : (t[o] = Ho(i, s));
          return;
        }
        t[o] = i;
      }),
  ...
  class ae {
      ...
      ((this.iterator = null),
        ...
        (this.onKeyDown = (t) => {
          if (!(!this.isEventReadyForHandling(t) || t.shiftKey === !0))
            switch (
              (ae.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode)
            ) {
              case y.TAB:
        ...
        (this.iterator = new Be(e.items, e.focusedItemClass)),
        (this.activateCallback = e.activateCallback),
        (this.allowedKeys = e.allowedKeys || ae.usedKeys));
    }
    get isActivated() {
    ...
    handleTabPress(e) {
      switch (e.shiftKey ? Be.directions.LEFT : Be.directions.RIGHT) {
        case Be.directions.RIGHT:
          this.flipRight();
          break;
        case Be.directions.LEFT:
          this.flipLeft();
          break;
      }
    }
  ...
  function ie(n) {
    return (e, t) =>
      [[n, e].filter((i) => !!i).join(Qi), t].filter((i) => !!i).join(es);
  }
  const Ce = ie("ce-hint"),
    Te = {
      root: Ce(),
      alignedStart: Ce(null, "align-left"),
      alignedCenter: Ce(null, "align-center"),
      title: Ce("title"),
  ...
  class ts {
    constructor(e) {
      ((this.nodes = {
        root: u.make("div", [
          Te.root,
          e.alignment === "center" ? Te.alignedCenter : Te.alignedStart,
        ]),
        title: u.make("div", Te.title, { textContent: e.title }),
      }),
        this.nodes.root.appendChild(this.nodes.title),
        e.description !== void 0 &&
          ((this.nodes.description = u.make("div", Te.description, {
  ...
  class pt {
    ...
    addHint(e, t) {
      const o = new ts(t);
      Re(e, o.getElement(), { placement: t.position, hidingDelay: 100 });
    }
    get children() {
      var e;
  ...
  class le extends pt {
      ...
      (super(e),
        ...
        (this.onErrorAnimationEnd = () => {
          ...
          ((o = this.nodes.icon) == null ||
            o.classList.remove(L.wobbleAnimation),
            (i = this.nodes.icon) == null ||
              i.removeEventListener("animationend", this.onErrorAnimationEnd));
        }),
    ...
    get isFocused() {
      return this.nodes.root === null
        ? !1
        : this.nodes.root.classList.contains(L.focused);
    }
    getElement() {
      return this.nodes.root;
    }
    ...
    make(e, t) {
      ...
      return (
        e.name && (i.dataset.itemName = e.name),
        (this.nodes.icon = u.make("div", [L.icon, L.iconTool], {
          innerHTML: e.icon || Ki,
        })),
        i.appendChild(this.nodes.icon),
        e.title !== void 0 &&
          i.appendChild(u.make("div", L.title, { innerHTML: e.title || "" })),
        e.secondaryLabel &&
          i.appendChild(
            u.make("div", L.secondaryTitle, { textContent: e.secondaryLabel }),
          ),
        this.hasChildren &&
          i.appendChild(
            u.make("div", [L.icon, L.iconChevronRight], { innerHTML: Ui }),
          ),
        this.isActive && i.classList.add(L.active),
        e.isDisabled && i.classList.add(L.disabled),
        e.hint !== void 0 &&
          ((s = t == null ? void 0 : t.hint) == null ? void 0 : s.enabled) !==
            !1 &&
          this.addHint(i, {
            ...e.hint,
            position:
              ((r = t == null ? void 0 : t.hint) == null
                ? void 0
                : r.position) || "right",
          }),
        i
    ...
    enableConfirmationMode(e) {
      ...
      ((this.nodes.root.innerHTML = o.innerHTML),
        this.nodes.root.classList.add(L.confirmationState),
    ...
    disableConfirmationMode() {
      ...
      ((this.nodes.root.innerHTML = e.innerHTML),
        this.nodes.root.classList.remove(L.confirmationState),
        (this.confirmationState = null),
        this.disableSpecialHoverAndFocusBehavior());
    }
    enableSpecialHoverAndFocusBehavior() {
      var e, t, o;
      ((e = this.nodes.root) == null || e.classList.add(L.noHover),
        (t = this.nodes.root) == null || t.classList.add(L.noFocus),
    ...
    animateError() {
      ...
      ((e = this.nodes.icon) != null &&
        e.classList.contains(L.wobbleAnimation)) ||
        ((t = this.nodes.icon) == null || t.classList.add(L.wobbleAnimation),
        (o = this.nodes.icon) == null ||
          o.addEventListener("animationend", this.onErrorAnimationEnd));
    }
  }
  const ft = ie("ce-popover-item-separator"),
    gt = { container: ft(), line: ft("line"), hidden: ft(null, "hidden") };
  class Wo extends pt {
    constructor() {
      (super(),
        (this.nodes = {
          root: u.make("div", gt.container),
          line: u.make("div", gt.line),
        }),
    ...
    toggleHidden(e) {
      var t;
      (t = this.nodes.root) == null || t.classList.toggle(gt.hidden, e);
    }
  }
  var Z = ((n) => (
    (n.Closed = "closed"),
    (n.ClosedOnActivate = "closed-on-activate"),
    n
  ))(Z || {});
  const z = ie("ce-popover"),
    P = {
      popover: z(),
  ...
  var me = ((n) => (
    (n.NestingLevel = "--nesting-level"),
    (n.PopoverHeight = "--popover-height"),
    (n.InlinePopoverWidth = "--inline-popover-width"),
    (n.TriggerItemLeft = "--trigger-item-left"),
    (n.TriggerItemTop = "--trigger-item-top"),
    n
  ))(me || {});
  const Yo = ie("ce-popover-item-html"),
    Ko = { root: Yo(), hidden: Yo(null, "hidden") };
  class Se extends pt {
    constructor(e, t) {
      var o, i;
      (super(e),
        (this.nodes = { root: u.make("div", Ko.root) }),
        this.nodes.root.appendChild(e.element),
        e.name && (this.nodes.root.dataset.itemName = e.name),
        e.hint !== void 0 &&
          ((o = t == null ? void 0 : t.hint) == null ? void 0 : o.enabled) !==
            !1 &&
          this.addHint(this.nodes.root, {
            ...e.hint,
            position:
              ((i = t == null ? void 0 : t.hint) == null
                ? void 0
                : i.position) || "right",
          }));
    }
    ...
    toggleHidden(e) {
      var t;
      (t = this.nodes.root) == null || t.classList.toggle(Ko.hidden, e);
    }
    getControls() {
  ...
  class Xo extends we {
    constructor(e, t = {}) {
      (super(),
        ...
        (this.nodes = {}),
        (this.nodes.popoverContainer = u.make("div", [P.popoverContainer])),
        (this.nodes.nothingFoundMessage = u.make(
          "div",
          [P.nothingFoundMessage],
          { textContent: this.messages.nothingFound },
        )),
        this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage),
        (this.nodes.items = u.make("div", [P.items])),
        this.items.forEach((o) => {
          const i = o.getElement();
          i !== null && this.nodes.items.appendChild(i);
        }),
        this.nodes.popoverContainer.appendChild(this.nodes.items),
        this.listeners.on(this.nodes.popoverContainer, "click", (o) =>
          this.handleClick(o),
        ),
        (this.nodes.popover = u.make("div", [P.popover, this.params.class])),
        this.nodes.popover.appendChild(this.nodes.popoverContainer));
    }
    get itemsDefault() {
      return this.items.filter((e) => e instanceof le);
    }
    getElement() {
      return this.nodes.popover;
    }
    show() {
      (this.nodes.popover.classList.add(P.popoverOpened),
        this.search !== void 0 && this.search.focus());
    }
    hide() {
      (this.nodes.popover.classList.remove(P.popoverOpened),
        this.nodes.popover.classList.remove(P.popoverOpenTop),
    ...
    buildItems(e) {
      return e.map((t) => {
        switch (t.type) {
          ...
          default:
            return new le(t, this.itemsRenderParams[_.Default]);
        }
      });
    }
    getTargetItem(e) {
      return this.items
        .filter((t) => t instanceof le || t instanceof Se)
        .find((t) => {
    ...
    handleItemClick(e) {
      if (!("isDisabled" in e && e.isDisabled)) {
        ...
        (this.itemsDefault.filter((t) => t !== e).forEach((t) => t.reset()),
          ...
          e.closeOnActivate && (this.hide(), this.emit(Z.ClosedOnActivate)));
      }
    }
    handleClick(e) {
  ...
  const mt = ie("cdx-search-field"),
    bt = { wrapper: mt(), icon: mt("icon"), input: mt("input") };
  class os extends we {
    constructor({ items: e, placeholder: t }) {
      (super(),
        (this.listeners = new Ee()),
        (this.items = e),
        (this.wrapper = u.make("div", bt.wrapper)));
      const o = u.make("div", bt.icon, { innerHTML: Zi });
      ((this.input = u.make("input", bt.input, {
        placeholder: t,
        tabIndex: -1,
      })),
    ...
    clear() {
      ((this.input.value = ""),
        (this.searchQuery = ""),
        this.emit(De.Search, { query: "", items: this.foundItems }));
    }
    destroy() {
      this.listeners.removeAll();
    }
  ...
  var ns = Object.defineProperty,
    ...
    ss = (n, e, t, o) => {
      for (
        var i = o > 1 ? void 0 : o ? is(e, t) : e, s = n.length - 1, r;
        s >= 0;
        s--
      )
        (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
      return (o && i && ns(e, t, i), i);
    };
  const Vo = class zn extends Xo {
    constructor(e, t) {
      (super(e, t),
        (this.nestingLevel = 0),
        ...
        (this.hide = () => {
          ...
          (super.hide(),
            ...
            (o = this.flipper) == null || o.deactivate(),
            (this.previouslyHoveredItem = null));
        }),
        (this.onFlip = () => {
        ...
        (this.onSearch = (o) => {
          ...
          (this.items.forEach((l) => {
            let c = !1;
            (l instanceof le
              ? (c = !o.items.includes(l))
              : (l instanceof Wo || l instanceof Se) && (c = s || !i),
              l.toggleHidden(c));
          }),
          ...
          const r =
            o.query === ""
              ...
              : o.items.map((l) => l.getElement());
          (a = this.flipper) != null &&
            a.isActivated &&
            (this.flipper.deactivate(), this.flipper.activate(r));
        }),
        e.nestingLevel !== void 0 && (this.nestingLevel = e.nestingLevel),
        this.nestingLevel > 0 &&
          this.nodes.popover.classList.add(P.popoverNested),
    ...
    show() {
      ...
      (this.nodes.popover.style.setProperty(
        ...
        this.shouldOpenBottom ||
          this.nodes.popover.classList.add(P.popoverOpenTop),
        this.shouldOpenRight ||
          this.nodes.popover.classList.add(P.popoverOpenLeft),
        super.show(),
    ...
    setTriggerItemPosition(e, t) {
      const o = t.getElement(),
        ...
        s = this.offsetTop + i;
      e.style.setProperty(me.TriggerItemTop, s + "px");
    }
    destroyNestedPopoverIfExists() {
      var e, t;
      this.nestedPopover === void 0 ||
        this.nestedPopover === null ||
        (this.nestedPopover.off(Z.ClosedOnActivate, this.hide),
    ...
    showNestedPopoverForItem(e) {
      ...
      ((this.nestedPopover = new zn({
        ...
        e.onChildrenOpen(),
        this.nestedPopover.on(Z.ClosedOnActivate, this.hide));
      const t = this.nestedPopover.getElement();
      return (
        this.nodes.popover.appendChild(t),
        this.setTriggerItemPosition(t, e),
        t.style.setProperty(
          me.NestingLevel,
    ...
    get size() {
      var i;
      const e = { height: 0, width: 0 };
      if (this.nodes.popover === null) return e;
      const t = this.nodes.popover.cloneNode(!0);
      ((t.style.visibility = "hidden"),
        (t.style.position = "absolute"),
        (t.style.top = "-1000px"),
        t.classList.add(P.popoverOpened),
        (i = t.querySelector("." + P.popoverNested)) == null || i.remove(),
    ...
    get flippableElements() {
      return this.items
        .map((t) => {
          if (t instanceof le) return t.getElement();
    ...
    toggleNothingFoundMessage(e) {
      this.nodes.nothingFoundMessage.classList.toggle(
        P.nothingFoundMessageDisplayed,
        e,
      );
    }
  };
  ss([fe], Vo.prototype, "size", 1);
  let vt = Vo;
  class rs extends vt {
    constructor(e) {
      const t = !ge();
      (super(
        { ...e, class: P.popoverInline },
        {
          [_.Default]: {
            wrapperTag: "button",
        ...
        this.items.forEach((o) => {
          (!(o instanceof le) && !(o instanceof Se)) ||
            (o.hasChildren && o.isChildrenOpen && this.showNestedItems(o));
        }));
    }
    get offsetLeft() {
      return this.nodes.popoverContainer === null
    ...
    setTriggerItemPosition(e, t) {
      const o = t.getElement(),
        i = o ? o.offsetLeft : 0,
        s = this.offsetLeft + i;
      e.style.setProperty(me.TriggerItemLeft, s + "px");
    }
    showNestedItems(e) {
    ...
    showNestedPopoverForItem(e) {
      ...
      return (
        t.getElement().classList.add(P.getPopoverNestedClass(t.nestingLevel)),
        t
      );
    }
    handleItemClick(e) {
  ...
  const qo = class Me {
    ...
    lock() {
      rt ? this.lockHard() : document.body.classList.add(Me.CSS.scrollLocked);
    }
    unlock() {
      rt
        ? this.unlockHard()
  ...
  let as = qo;
  const kt = ie("ce-popover-header"),
    yt = { root: kt(), text: kt("text"), backButton: kt("back-button") };
  class ls {
    constructor({ text: e, onBackButtonClick: t }) {
      ((this.listeners = new Ee()),
        ...
        (this.nodes = {
          root: u.make("div", [yt.root]),
          backButton: u.make("button", [yt.backButton]),
          text: u.make("div", [yt.text]),
        }),
        (this.nodes.backButton.innerHTML = zi),
  ...
  class Zo extends Xo {
    constructor(e) {
      (super(e, {
        [_.Default]: { hint: { enabled: !1 } },
        [_.Html]: { hint: { enabled: !1 } },
      }),
        (this.scrollLocker = new as()),
        (this.history = new cs()),
        (this.isHidden = !0),
        (this.nodes.overlay = u.make("div", [P.overlay, P.overlayHidden])),
    ...
    show() {
      (this.nodes.overlay.classList.remove(P.overlayHidden),
        super.show(),
    ...
    hide() {
      this.isHidden ||
        (super.hide(),
        this.nodes.overlay.classList.add(P.overlayHidden),
  ...
  class ds extends E {
    constructor() {
      (super(...arguments),
        (this.opened = !1),
        (this.hasMobileLayoutToggleListener = !1),
        ...
        (this.close = () => {
          this.opened &&
            ...
            this.popover &&
              (this.popover.off(Z.Closed, this.onPopoverClose),
    ...
    make() {
      ((this.nodes.wrapper = u.make("div", [this.CSS.settings])),
        this.eventsDispatcher.on(xe, this.close),
        (this.hasMobileLayoutToggleListener = !0));
    }
    destroy() {
      (this.removeAllNodes(),
        this.listeners.destroy(),
        this.hasMobileLayoutToggleListener &&
          (this.eventsDispatcher.off(xe, this.close),
          (this.hasMobileLayoutToggleListener = !1)));
    }
    async open(e = this.Editor.BlockManager.currentBlock) {
      ...
      ((this.popover = new i({
        ...
        messages: {
          nothingFound: H.ui(W.ui.popover, "Nothing found"),
          search: H.ui(W.ui.popover, "Filter"),
        },
      })),
        this.popover.on(Z.Closed, this.onPopoverClose),
        (s = this.nodes.wrapper) == null || s.append(this.popover.getElement()),
        this.popover.show());
    }
    getElement() {
    ...
    async getTunesItems(e, t, o) {
      ...
      o !== void 0 &&
        o.length > 0 &&
        (i.push(...o), i.push({ type: _.Separator }));
      const s = Array.from(this.Editor.Tools.blockTools.values()),
        a = (await Po(e, s)).reduce(
          (l, c) => (
            c.toolbox.forEach((d) => {
              l.push({
                icon: d.icon,
                title: H.t(W.toolNames, d.title),
                name: c.name,
                closeOnActivate: !0,
                onActivate: async () => {
                  const { BlockManager: h, Caret: p, Toolbar: g } = this.Editor,
      ...
      return (
        a.length > 0 &&
          (i.push({
            icon: Uo,
            name: "convert-to",
            title: H.ui(W.ui.popover, "Convert to"),
            children: { searchable: !0, items: a },
          }),
          i.push({ type: _.Separator })),
        i.push(...t),
  ...
  class ps {
    ...
    add(e) {
      ...
      const o = new hs({ name: e.name, on: e.on, callback: e.handler }),
  ...
  var fs = Object.defineProperty,
    ...
    Jo = (n, e, t, o) => {
      for (
        var i = o > 1 ? void 0 : o ? gs(e, t) : e, s = n.length - 1, r;
        s >= 0;
        s--
      )
        (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
    ...
    Fe = ((n) => (
      (n.Opened = "toolbox-opened"),
      (n.Closed = "toolbox-closed"),
      (n.BlockAdded = "toolbox-block-added"),
      n
    ))(Fe || {});
  const wt = class Un extends we {
    constructor({ api: e, tools: t, i18nLabels: o }) {
      (super(),
        ...
        (this.nodes = { toolbox: u.make("div", Un.CSS.toolbox) }),
        this.initPopover(),
        this.api.events.on(xe, this.handleMobileLayoutToggle));
    }
    get isEmpty() {
    ...
    destroy() {
      ...
      (super.destroy(),
        ...
        (e = this.popover) == null || e.off(Z.Closed, this.onPopoverClose),
        this.listeners.destroy(),
        this.api.events.off(xe, this.handleMobileLayoutToggle));
    }
    ...
    get toolboxItemsToBeDisplayed() {
      const e = (t, o, i = !0) => ({
        icon: t.icon,
        title: H.t(W.toolNames, t.title || Le(o.name)),
        name: o.name,
        onActivate: () => {
          this.toolButtonActivated(o.name, t.data);
        },
        secondaryLabel: o.shortcut && i ? it(o.shortcut) : "",
      });
      return this.toolsToBeDisplayed.reduce(
        (t, o) => (
          Array.isArray(o.toolbox)
            ? o.toolbox.forEach((i, s) => {
                t.push(e(i, o, s === 0));
              })
    ...
    async insertNewBlock(e, t) {
      ...
      (a.call(te.APPEND_CALLBACK),
        this.api.caret.setToBlock(s),
        this.emit("toolbox-block-added", { block: a }),
        this.api.toolbar.close());
    }
  };
  (Jo([fe], wt.prototype, "toolsToBeDisplayed", 1),
    Jo([fe], wt.prototype, "toolboxItemsToBeDisplayed", 1));
  let ms = wt;
  ...
  class vs extends E {
    ...
    async make() {
      ((this.nodes.wrapper = u.make("div", this.CSS.toolbar)),
        ["content", "actions"].forEach((s) => {
          this.nodes[s] = u.make("div", this.CSS[s]);
        }),
        u.append(this.nodes.wrapper, this.nodes.content),
        u.append(this.nodes.content, this.nodes.actions),
        (this.nodes.plusButton = u.make("div", this.CSS.plusButton, {
          innerHTML: qi,
        })),
        u.append(this.nodes.actions, this.nodes.plusButton),
      ...
      const e = u.make("div");
      (e.appendChild(
        document.createTextNode(H.ui(W.ui.toolbar.toolbox, "Add")),
      ),
        e.appendChild(
          u.make("div", this.CSS.plusButtonShortcut, { textContent: "/" }),
        ),
        Re(this.nodes.plusButton, e, { hidingDelay: 400 }),
        (this.nodes.settingsToggler = u.make("span", this.CSS.settingsToggler, {
          innerHTML: Vi,
        })),
        u.append(this.nodes.actions, this.nodes.settingsToggler));
      const t = u.make("div"),
        o = u.text(H.ui(W.ui.blockTunes.toggler, "Click to tune")),
        i = await bs("Slash", "/");
      (t.appendChild(o),
        t.appendChild(
          u.make("div", this.CSS.plusButtonShortcut, {
            textContent: it(`CMD + ${i}`),
          }),
        ),
        Re(this.nodes.settingsToggler, t, { hidingDelay: 400 }),
        u.append(this.nodes.actions, this.makeToolbox()),
        u.append(this.nodes.actions, this.Editor.BlockSettings.getElement()),
        u.append(this.Editor.UI.nodes.wrapper, this.nodes.wrapper));
    }
    makeToolbox() {
      return (
        (this.toolboxInstance = new ms({
          api: this.Editor.API.methods,
          tools: this.Editor.Tools.blockTools,
          i18nLabels: {
            filter: H.ui(W.ui.popover, "Filter"),
            nothingFound: H.ui(W.ui.popover, "Nothing found"),
          },
        })),
        this.toolboxInstance.on(Fe.Opened, () => {
          this.Editor.UI.nodes.wrapper.classList.add(
            this.CSS.openedToolboxHolderModifier,
          );
        }),
        this.toolboxInstance.on(Fe.Closed, () => {
          this.Editor.UI.nodes.wrapper.classList.remove(
            this.CSS.openedToolboxHolderModifier,
          );
        }),
        this.toolboxInstance.on(Fe.BlockAdded, ({ block: e }) => {
  ...
  var ce = ((n) => (
    ...
    je = ((n) => (
      (n.Shortcut = "shortcut"),
      (n.Toolbox = "toolbox"),
      (n.EnabledInlineTools = "inlineToolbar"),
      (n.EnabledBlockTunes = "tunes"),
      (n.Config = "config"),
      n
    ))(je || {}),
    en = ((n) => (
      (n.Shortcut = "shortcut"),
      (n.SanitizeConfig = "sanitize"),
      n
    ))(en || {}),
    ve = ((n) => (
      (n.IsEnabledLineBreaks = "enableLineBreaks"),
      (n.Toolbox = "toolbox"),
      (n.ConversionConfig = "conversionConfig"),
      (n.IsReadOnlySupported = "isReadOnlySupported"),
      (n.PasteConfig = "pasteConfig"),
      n
    ))(ve || {}),
    He = ((n) => (
      (n.IsInline = "isInline"),
  ...
  class xt {
    ...
    isInline() {
      return this.type === ce.Inline;
    }
    isBlock() {
      return this.type === ce.Block;
    }
    isTune() {
      return this.type === ce.Tune;
    }
  }
  class ks extends E {
    constructor({ config: e, eventsDispatcher: t }) {
      (super({ config: e, eventsDispatcher: t }),
        ...
        (this.opened = !1),
        (this.popover = null),
        (this.toolbarVerticalMargin = ge() ? 20 : 6),
        (this.tools = new Map()),
        window.requestIdleCallback(
          () => {
            this.make();
    ...
    close() {
      ...
      if (this.opened) {
        for (const [o, i] of this.tools) {
          ...
          (s !== void 0 && be.remove(this.Editor.UI.nodes.redactor, s),
            M(i.clear) && i.clear());
        }
        ((this.tools = new Map()),
          this.reset(),
    ...
    move(e) {
      ...
      (i.x + e + o.x > this.Editor.UI.contentRect.right &&
        (i.x = this.Editor.UI.contentRect.right - e - o.x),
    ...
    allowedToShow() {
      ...
      const i = u.isElement(t.anchorNode)
        ? t.anchorNode
        : t.anchorNode.parentElement;
      if (i === null || (t !== null && e.includes(i.tagName))) return !1;
      const s = this.Editor.BlockManager.getBlock(t.anchorNode);
      return !s ||
        this.getTools().some((c) => s.tool.inlineTools.has(c.name)) === !1
        ? !1
        : i.closest("[contenteditable]") !== null;
    }
    getTools() {
      ...
      return e
        ? Array.from(e.tool.inlineTools.values()).filter(
            (o) =>
              !(this.Editor.ReadOnly.isEnabled && o.isReadOnlySupported !== !0),
          )
        : [];
    }
    createToolsInstances() {
      ((this.tools = new Map()),
        this.getTools().forEach((t) => {
          const o = t.create();
          this.tools.set(t, o);
        }));
    }
    async getPopoverItems() {
      ...
      for (const [o, i] of this.tools) {
        ...
        const a = r !== void 0 ? it(r) : void 0,
          l = H.t(W.toolNames, o.title || Le(o.name));
        ([s].flat().forEach((c) => {
          var h, p;
          const d = {
            name: o.name,
          ...
          if (u.isElement(c)) {
            const g = { ...d, element: c, type: _.Html };
            if (M(i.renderActions)) {
              const f = i.renderActions();
              g.children = {
                isOpen:
                  (h = i.checkState) == null ? void 0 : h.call(i, b.get()),
                isFlippable: !1,
                items: [{ type: _.Html, element: f }],
              };
            } else (p = i.checkState) == null || p.call(i, b.get());
            e.push(g);
          } else if (c.type === _.Html) e.push({ ...d, ...c, type: _.Html });
          else if (c.type === _.Separator) e.push({ type: _.Separator });
          else {
            const g = { ...d, ...c, type: _.Default };
            ("children" in g && t !== 0 && e.push({ type: _.Separator }),
              e.push(g),
              "children" in g &&
                t < this.tools.size - 1 &&
                e.push({ type: _.Separator }));
          }
        }),
          t++);
      }
    ...
    getToolShortcut(e) {
      ...
      return Array.from(i.keys()).includes(e)
        ? this.inlineTools[e][en.Shortcut]
        : o == null
          ? void 0
          : o.shortcut;
    }
      ...
      be.add({
        ...
        handler: (o) => {
          ...
          i &&
            ...
            (o.preventDefault(),
            (s = this.popover) == null || s.activateItemByName(e));
        },
        on: document,
      });
    }
  ...
  function on(n, e, t, o) {
    ...
    o === "left"
      ? (i.setStart(n, 0), i.setEnd(e, t))
      : (i.setStart(e, t), i.setEnd(n, n.childNodes.length));
  ...
  function $e(n) {
    ...
    if (e === null || u.isEmpty(n)) return !0;
    if (u.isNativeInput(e)) return e.selectionEnd === 0;
    if (u.isEmpty(n)) return !0;
    const [t, o] = tn();
    return t === null ? !1 : on(n, t, o, "left");
  }
  function ze(n) {
    ...
    const [t, o] = tn();
    return t === null ? !1 : on(n, t, o, "right");
  }
  var nn = {},
    Bt = {},
    Ue = {},
  ...
  var sn = {},
    It = {};
  (Object.defineProperty(It, "__esModule", { value: !0 }), (It.append = Es));
  function Es(n, e) {
    Array.isArray(e)
  ...
  function Is(n) {
    ...
    else e = (0, Ss.isContentEditable)(n);
    return e;
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
  ...
  function cn(n) {
    return se(n) === "function" || se(n) === "asyncfunction";
  }
  function Ds(n) {
    return cn(n) && /^\s*class\s+/.test(n.toString());
  }
  function Fs(n) {
    return se(n) === "number";
  }
  ...
  function Dt(n, ...e) {
    ...
    if (Ye(n) && Ye(t))
      for (const o in t)
        Ye(t[o])
          ? (n[o] === void 0 && Object.assign(n, { [o]: {} }), Dt(n[o], t[o]))
          : Object.assign(n, { [o]: t[o] });
    return Dt(n, ...e);
  }
  function zs(n, e, t) {
  ...
  const Ys = {
    ...
    Ks = { LEFT: 0, WHEEL: 1, RIGHT: 2, BACKWARD: 3, FORWARD: 4 };
  let Xs = class {
    constructor() {
      ...
      Object.defineProperty(
        {
          ...
          cacheable: Os,
          capitalize: Ls,
          copyTextToClipboard: Ps,
          debounce: Ns,
          deepMerge: Dt,
          deprecationAssert: zs,
          getUserOS: ln,
          getValidUrl: Us,
          isBoolean: Rs,
          isClass: Ds,
  ...
  (Object.defineProperty(Nt, "__esModule", { value: !0 }),
    (Nt.containsOnlyInlineElements = Gs));
  var qs = Ft,
    Zs = Ot;
  function Gs(n) {
    var e;
    (0, qs.isString)(n)
      ? ((e = document.createElement("div")), (e.innerHTML = n))
      : (e = n);
    var t = function (o) {
      return (
        !(0, Zs.blockElements)().includes(o.tagName.toLowerCase()) &&
        Array.from(o.children).every(t)
      );
    };
  ...
  var dn = {},
    ...
    Ke = {},
    Ht = {};
  (Object.defineProperty(Ht, "__esModule", { value: !0 }), (Ht.make = Js));
  function Js(n, e, t) {
    var o;
  ...
  var un = {},
    $t = {};
  (Object.defineProperty($t, "__esModule", { value: !0 }),
    ($t.getContentLength = or));
  var tr = ue;
  function or(n) {
    var e, t;
    return (0, tr.isNativeInput)(n)
      ? n.value.length
      : n.nodeType === Node.TEXT_NODE
        ? n.length
        : (t =
              (e = n.textContent) === null || e === void 0
                ? void 0
      ...
      function (n, e, t) {
        if (t || arguments.length === 2)
          for (var o = 0, i = e.length, s; o < i; o++)
            (s || !(o in e)) &&
              (s || (s = Array.prototype.slice.call(e, 0, o)), (s[o] = e[o]));
        return n.concat(s || Array.prototype.slice.call(e));
      };
  (Object.defineProperty(Ut, "__esModule", { value: !0 }),
    (Ut.getDeepestBlockElements = pn));
  var nr = We;
  function pn(n) {
    return (0, nr.containsOnlyInlineElements)(n)
      ? [n]
      : Array.from(n.children).reduce(function (e, t) {
          return hn(hn([], e, !0), pn(t), !0);
        }, []);
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
  ...
  function gn(n, e) {
    ...
    if (n.nodeType === Node.ELEMENT_NODE && n[t]) {
      ...
      if (
        (0, lr.isSingleTag)(i) &&
        !(0, rr.isNativeInput)(i) &&
        !(0, ar.isLineBreakTag)(i)
      )
        if (i[o]) i = i[o];
  ...
  var cr = We,
    ...
    hr = ue;
  function pr(n) {
    return Array.from(n.querySelectorAll((0, ur.allInputsSelector)())).reduce(
      function (e, t) {
        return (0, hr.isNativeInput)(t) || (0, cr.containsOnlyInlineElements)(t)
          ? qe(qe([], e, !0), [t], !1)
          : qe(qe([], e, !0), (0, dr.getDeepestBlockElements)(t), !0);
      },
      [],
    );
  }
  ...
  var qt = {},
    Zt = {};
  (Object.defineProperty(Zt, "__esModule", { value: !0 }), (Zt.isElement = mr));
  var gr = Ft;
  function mr(n) {
    return (0, gr.isNumber)(n)
      ? !1
      : !!n && !!n.nodeType && n.nodeType === Node.ELEMENT_NODE;
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.isElement = void 0));
  ...
  var vn = {},
    ...
    Jt = {},
    Qt = {};
  (Object.defineProperty(Qt, "__esModule", { value: !0 }), (Qt.isLeaf = br));
  function br(n) {
  ...
  function Er(n, e) {
    var t = "";
    return (0, wr.isSingleTag)(n) && !(0, vr.isLineBreakTag)(n)
      ? !1
      : ((0, kr.isElement)(n) && (0, yr.isNativeInput)(n)
          ? (t = n.value)
          : n.textContent !== null && (t = n.textContent.replace("​", "")),
  ...
  function Cr(n, e) {
    ...
    for (var t = [n]; t.length > 0; ) {
      var o = t.shift();
      if (o) {
        if (((n = o), (0, xr.isLeaf)(n) && !(0, Br.isNodeEmpty)(n, e)))
          return !1;
  ...
  var Tr = Ft;
  function Sr(n) {
    return (0, Tr.isNumber)(n)
      ? !1
      : !!n && !!n.nodeType && n.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.isFragment = void 0));
  ...
  var wn = {},
    io = {};
  (Object.defineProperty(io, "__esModule", { value: !0 }), (io.offset = _r));
  function _r(n) {
    var e = n.getBoundingClientRect(),
      ...
      i = e.top + o,
      s = e.left + t;
    return { top: i, left: s, bottom: i + e.height, right: s + e.width };
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
      (n.offset = void 0));
  ...
  var En = {},
    so = {};
  (Object.defineProperty(so, "__esModule", { value: !0 }), (so.prepend = Mr));
  function Mr(n, e) {
    Array.isArray(e)
      ? ((e = e.reverse()),
        e.forEach(function (t) {
    ...
    (function (n) {
      (Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.prepend =
          ...
          n.isElement =
          n.isContentEditable =
          n.isCollapsedWhitespaces =
          n.findAllInputs =
          n.isNativeInput =
          n.allInputsSelector =
          n.getDeepestNode =
          n.getDeepestBlockElements =
          n.getContentLength =
          n.fragmentToString =
          n.containsOnlyInlineElements =
          n.canSetCaret =
          n.calculateBaseline =
          n.blockElements =
          n.append =
  ...
  function Lr(n, e, t, o, i) {
    ...
    if (
      (o === "left"
        ? (r.setStart(n, 0), r.setEnd(e, t))
        : (r.setStart(e, t), r.setEnd(n, n.childNodes.length)),
      i === !0)
    ) {
      var a = r.extractContents();
      return (0, Ar.fragmentToString)(a);
    }
  ...
  (Object.defineProperty(Ue, "__esModule", { value: !0 }),
    (Ue.checkContenteditableSliceForEmptiness = Rr));
  var Pr = de,
    Nr = Ze;
  function Rr(n, e, t, o) {
    var i = (0, Nr.getContenteditableSlice)(n, e, t, o);
    return (0, Pr.isCollapsedWhitespaces)(i);
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
  ...
  var Bn = {},
    ro = {};
  (Object.defineProperty(ro, "__esModule", { value: !0 }), (ro.focus = Fr));
  var Dr = de;
  function Fr(n, e) {
    var t, o;
    if ((e === void 0 && (e = !0), (0, Dr.isNativeInput)(n))) {
      n.focus();
  ...
  var Cn = {},
    Je = {};
  (Object.defineProperty(Je, "__esModule", { value: !0 }), (Je.getRange = Hr));
  function Hr() {
    var n = window.getSelection();
  ...
  (Object.defineProperty(lo, "__esModule", { value: !0 }),
    (lo.isCaretAtEndOfInput = Ur));
  var Sn = de,
    $r = ao,
    zr = Bt;
  function Ur(n) {
    var e = (0, Sn.getDeepestNode)(n, !0);
    if (e === null) return !0;
    if ((0, Sn.isNativeInput)(e)) return e.selectionEnd === e.value.length;
    var t = (0, $r.getCaretNodeAndOffset)(),
      o = t[0],
      i = t[1];
    return o === null
      ? !1
      : (0, zr.checkContenteditableSliceForEmptiness)(n, o, i, "right");
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
  ...
  (Object.defineProperty(co, "__esModule", { value: !0 }),
    (co.isCaretAtStartOfInput = Kr));
  var Qe = de,
    Wr = Ge,
    Yr = Ue;
  function Kr(n) {
    var e = (0, Qe.getDeepestNode)(n);
    if (e === null || (0, Qe.isEmpty)(n)) return !0;
    if ((0, Qe.isNativeInput)(e)) return e.selectionEnd === 0;
    if ((0, Qe.isEmpty)(n)) return !0;
    var t = (0, Wr.getCaretNodeAndOffset)(),
      o = t[0],
      i = t[1];
    return o === null
      ? !1
      : (0, Yr.checkContenteditableSliceForEmptiness)(n, o, i, "left");
  }
  (function (n) {
    (Object.defineProperty(n, "__esModule", { value: !0 }),
  ...
  var On = {},
    uo = {};
  (Object.defineProperty(uo, "__esModule", { value: !0 }), (uo.save = qr));
  var Xr = de,
    Vr = Je;
  function qr() {
    var n = (0, Vr.getRange)(),
  ...
  ((function (n) {
    ...
    (function (n) {
      (Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.save =
          n.isCaretAtStartOfInput =
          n.isCaretAtEndOfInput =
          n.getRange =
          n.getCaretNodeAndOffset =
          n.focus =
          n.getContenteditableSlice =
          n.checkContenteditableSliceForEmptiness =
            void 0));
      var e = Bt;
      Object.defineProperty(n, "checkContenteditableSliceForEmptiness", {
        enumerable: !0,
  ...
  class Zr extends E {
      ...
      t.anyBlockSelected &&
        t.copySelectedBlocks(e).then(() => {
          const s = o.removeSelectedBlocks(),
            r = o.insertDefaultBlockAtIndex(s, !0);
    ...
    tabPressed(e) {
      ...
      if (t.opened) return;
      (e.shiftKey ? o.navigatePrevious(!0) : o.navigateNext(!0)) &&
        e.preventDefault();
    }
    commandSlashPressed() {
    ...
    slashPressed(e) {
      !this.Editor.UI.nodes.wrapper.contains(e.target) ||
    ...
    backspace(e) {
      ...
      No(s, i) ? this.mergeBlocks(s, i) : o.setToBlock(s, o.positions.END);
    }
    delete(e) {
      const { BlockManager: t, Caret: o } = this.Editor,
        { currentBlock: i, nextBlock: s } = t;
      if (!b.isCollapsed || !ze(i.currentInput)) return;
      if (
        (e.preventDefault(),
        this.Editor.Toolbar.close(),
      ...
      No(i, s) ? this.mergeBlocks(i, s) : o.setToBlock(s, o.positions.START);
    }
    mergeBlocks(e, t) {
      const { BlockManager: o, Toolbar: i } = this.Editor;
      e.lastInput !== void 0 &&
        (nn.focus(e.lastInput, !1),
    ...
    arrowRightAndDown(e) {
      const t =
        ae.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === y.TAB);
      if (this.Editor.UI.someToolbarOpened && t) return;
      this.Editor.Toolbar.close();
      const { currentBlock: o } = this.Editor.BlockManager,
        s =
          ((o == null ? void 0 : o.currentInput) !== void 0
            ? ze(o.currentInput)
            : void 0) || this.Editor.BlockSelection.anyBlockSelected;
      if (e.shiftKey && e.keyCode === y.DOWN && s) {
        this.Editor.CrossBlockSelection.toggleBlockSelectedState();
        return;
      }
      if (
        e.keyCode === y.DOWN || (e.keyCode === y.RIGHT && !this.isRtl)
    ...
    arrowLeftAndUp(e) {
      if (this.Editor.UI.someToolbarOpened) {
        if (
          ae.usedKeys.includes(e.keyCode) &&
          (!e.shiftKey || e.keyCode === y.TAB)
        )
          return;
      ...
      const { currentBlock: t } = this.Editor.BlockManager,
        i =
          ((t == null ? void 0 : t.currentInput) !== void 0
            ? $e(t.currentInput)
            : void 0) || this.Editor.BlockSelection.anyBlockSelected;
      ...
      if (
        e.keyCode === y.UP || (e.keyCode === y.LEFT && !this.isRtl)
          ? this.Editor.Caret.navigatePrevious()
          : this.Editor.Caret.navigateNext()
      ) {
        e.preventDefault();
  ...
  class ho {
    ...
    get nodes() {
      return xo(this.workingArea.children);
    }
    static set(e, t, o) {
    ...
    swap(e, t) {
      ...
      (u.swap(this.blocks[e].holder, o.holder),
    ...
    insert(e, t, o = !1) {
      ...
      (e > this.length && (e = this.length),
        o && (this.blocks[e].holder.remove(), this.blocks[e].call(te.REMOVED)));
      const i = o ? 1 : 0;
    ...
    insertMany(e, t) {
      ...
      e.forEach((i) => i.call(te.RENDERED));
    }
    remove(e) {
      (isNaN(e) && (e = this.length - 1),
        this.blocks[e].holder.remove(),
        this.blocks[e].call(te.REMOVED),
        this.blocks.splice(e, 1));
    }
    removeAll() {
      ((this.workingArea.innerHTML = ""),
        this.blocks.forEach((e) => e.call(te.REMOVED)),
  ...
  class Qr extends E {
    ...
    prepare() {
      const e = new ho(this.Editor.UI.nodes.redactor);
      ((this._blocks = new Proxy(e, { set: ho.set, get: ho.get })),
    ...
    insert({
      ...
      const c = this.composeBlock({ id: e, tool: t, data: o, tunes: a });
      return (
        r && this.blockDidMutated(_n, this.getBlockByIndex(l), { index: l }),
        this._blocks.insert(l, c, r),
        this.blockDidMutated(Mn, c, { index: l }),
        s
    ...
    async update(e, t, o) {
      ...
      return (
        ...
        this.blockDidMutated(An, s, { index: r }),
        s
      );
    }
    replace(e, t, o) {
      const i = this.getBlockIndex(e);
      return this.insert({ tool: t, data: o, index: i, replace: !0 });
    }
    paste(e, t, o = !1) {
      const i = this.insert({ tool: e, replace: o });
      try {
        window.requestIdleCallback(() => {
          i.call(te.ON_PASTE, t);
        });
      } catch (s) {
        T(`${e}: onPaste callback call is failed`, "error", s);
      }
      return i;
    }
    insertDefaultBlockAtIndex(e, t = !1) {
      ...
      return (
        (this._blocks[e] = o),
        this.blockDidMutated(Mn, o, { index: e }),
        t
    ...
    async mergeBlocks(e, t) {
      ...
      if (e.name === t.name && e.mergeable) {
        ...
        const [s] = dt([i], e.tool.sanitizeConfig);
        o = s;
      } else if (e.mergeable && Pe(t, "export") && Pe(e, "import")) {
        const i = await t.exportDataAsString(),
          s = q(i, e.tool.sanitizeConfig);
        o = Ro(s, e.tool.conversionConfig);
      }
      o !== void 0 &&
        (await e.mergeWith(o),
        this.removeBlock(t),
    ...
    removeBlock(e, t = !0) {
      return new Promise((o) => {
        ...
        (this._blocks.remove(i),
          e.destroy(),
          this.blockDidMutated(_n, e, { index: i }),
    ...
    split() {
      const e = this.Editor.Caret.extractFragmentFromCaretPosition(),
        t = u.make("div");
      t.appendChild(e);
      const o = { text: u.isEmpty(t) ? "" : t.innerHTML };
    ...
    move(e, t = this.currentBlockIndex) {
      ...
      (this._blocks.move(e, t),
        (this.currentBlockIndex = e),
        this.blockDidMutated(Gr, this.currentBlock, {
          fromIndex: t,
          toIndex: e,
        }));
    }
    async convert(e, t, o) {
      ...
      const r = await e.exportDataAsString(),
        a = q(r, s.sanitizeConfig);
      let l = Ro(a, s.conversionConfig, s.settings);
    ...
    bindBlockEvents(e) {
      ...
      (this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
        ...
        e.on("didMutated", (o) =>
          this.blockDidMutated(An, o, { index: this.getBlockIndex(o) }),
        ));
    }
    disableModuleBindings() {
      this.readOnlyMutableListeners.clearAll();
    ...
    blockDidMutated(e, t, o) {
      const i = new CustomEvent(e, { detail: { target: new ee(t), ...o } });
      return (this.eventsDispatcher.emit(_o, { event: i }), t);
    }
  }
  class ea extends E {
    constructor() {
    ...
    copySelectedBlocks(e) {
      ...
      this.selectedBlocks.forEach((s) => {
        const r = q(s.holder.innerHTML, this.sanitizerConfig),
          a = u.make("p");
...
`),
    ...
    handleCommandA(e) {
      if (
        (this.Editor.RectangleSelection.clearSelection(),
        u.isNativeInput(e.target) && !this.readyToBlockSelection)
      ) {
  ...
  class et extends E {
    ...
    setToBlock(e, t = this.positions.DEFAULT, o = 0) {
      ...
      let a,
        l = o;
      if (t === this.positions.START) ((a = u.getDeepestNode(r, !1)), (l = 0));
    ...
    set(e, t = 0) {
      const { top: i, bottom: s } = b.setCursor(e, t),
        { innerHeight: r } = window;
      i < 0
        ? window.scrollBy(0, i - 30)
        : s > r && window.scrollBy(0, s - r + 30);
    }
    setToTheLastBlock() {
    ...
    createShadow(e) {
      ...
      (t.classList.add(et.CSS.shadowCaret),
        e.insertAdjacentElement("beforeend", t));
    }
    restoreCaret(e) {
      const t = e.querySelector(`.${et.CSS.shadowCaret}`);
      if (!t) return;
      new b().expandToTag(t);
      const i = document.createRange();
    ...
    insertContentAtCaretPosition(e) {
      ...
      (l !== null &&
        l.textContent !== null &&
        a.setStart(l, l.textContent.length),
        i.removeAllRanges(),
        i.addRange(a));
    }
  }
  class ta extends E {
    ...
    enableCrossBlockSelection(e) {
      ...
      (b.isCollapsed || this.Editor.BlockSelection.clearSelection(e),
  ...
  class sa extends E {
    constructor({ config: e, eventsDispatcher: t }) {
      (super({ config: e, eventsDispatcher: t }),
        ...
        this.eventsDispatcher.on(_o, (o) => {
          this.particularBlockChanged(o.event);
        }),
        this.eventsDispatcher.on(Mo, () => {
          this.disable();
        }),
        this.eventsDispatcher.on(Ao, () => {
          this.enable();
        }));
    }
    enable() {
    ...
    redactorChanged(e) {
      this.eventsDispatcher.emit(at, { mutations: e });
    }
  }
  const Ln = class Wn extends E {
    constructor() {
      (super(...arguments),
    ...
    async processDataTransfer(e, t = !1) {
      ...
      const c = Object.keys(this.toolsTags).reduce(
          (p, g) => (
            (p[g.toLowerCase()] = this.toolsTags[g].sanitizationConfig ?? {}),
            p
          ),
          {},
        ),
        ...
        h = q(l, d);
      !h.trim() || h.trim() === a || !u.isHTMLString(h)
    ...
    collectTagNames(e) {
      return Q(e) ? [e] : N(e) ? Object.keys(e) : [];
    }
    getTagsConfig(e) {
      ...
      e.pasteConfig === !1 ||
        ...
        Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
          (o instanceof RegExp ||
            ...
            this.toolsPatterns.push({ key: t, pattern: o, tool: e }));
        });
    }
    isNativeBehaviour(e) {
      return u.isNativeInput(e);
    ...
    async processFiles(e) {
      const { BlockManager: t } = this.Editor;
      let o;
      ((o = await Promise.all(Array.from(e).map((r) => this.processFile(r)))),
        (o = o.filter((r) => !!r)));
          ...
          .map((s) => {
            ...
            switch (s.nodeType) {
              ...
              case Node.ELEMENT_NODE:
                ((r = s),
                  (l = !0),
                  this.toolsTags[r.tagName] &&
                    (a = this.toolsTags[r.tagName].tool));
                break;
            }
            const { tags: c } = a.pasteConfig || { tags: [] },
              d = c.reduce(
                (g, f) => (
                  this.collectTagNames(f).forEach((O) => {
                    const S = N(f) ? f[O] : null;
                    g[O.toLowerCase()] = S || {};
                  }),
                  g
                ),
            ...
            if (r.tagName.toLowerCase() === "table") {
              ...
              r = u.make("div", void 0, { innerHTML: g }).firstChild;
            } else r.innerHTML = q(r.innerHTML, h);
            const p = this.composePasteEvent("tag", { data: r });
            return { content: r, isBlock: l, tool: a.name, event: p };
          })
          .filter((s) => {
    ...
    processPlain(e) {
      ...
      return e
        ...
        .map((i) => {
          ...
          return { content: s, tool: o, isBlock: !1, event: r };
        });
    }
    async processSingleBlock(e) {
      ...
      if (
        !i ||
        e.tool !== i.name ||
        !u.containsOnlyInlineElements(e.content.innerHTML)
      ) {
        this.insertBlock(
          e,
    ...
    async processInlinePaste(e) {
      ...
      if (
        ...
        i.textContent.length < Wn.PATTERN_PROCESSING_MAX_LENGTH
      ) {
      ...
      if (t.currentBlock && t.currentBlock.currentInput) {
        ...
        document.execCommand("insertHTML", !1, q(i.innerHTML, r));
    ...
    insertEditorJSData(e) {
      ...
      dt(e, (r) => i.blockTools.get(r).sanitizeConfig).forEach(
        ({ tool: r, data: a }, l) => {
          let c = !1;
          l === 0 &&
            (c =
              ...
              t.currentBlock.tool.isDefault &&
              t.currentBlock.isEmpty);
          const d = t.insert({ tool: r, data: a, replace: c });
    ...
    processElementNode(e, t, o) {
      const i = Object.keys(this.toolsTags),
        ...
        h = Array.from(s.children).some(({ tagName: p }) =>
  ...
  Ln.PATTERN_PROCESSING_MAX_LENGTH = 450;
  let ra = Ln;
  class aa extends E {
    constructor() {
      (super(...arguments),
  ...
  class Ie extends E {
    ...
    processMouseDown(e) {
      ...
      e.target.closest(u.allInputsSelector) !== null ||
    ...
    genHTML() {
      const { UI: e } = this.Editor,
        ...
        o = u.make("div", Ie.CSS.overlay, {}),
        i = u.make("div", Ie.CSS.overlayContainer, {}),
        s = u.make("div", Ie.CSS.rect, {});
      return (
        i.appendChild(s),
        o.appendChild(i),
        t.appendChild(o),
        (this.overlayRectangle = s),
        { container: t, overlay: o }
      );
    }
    scrollVertical(e) {
    ...
    genInfoForMouseSelection() {
      ...
      let r;
      s !== void 0 &&
        (r = this.Editor.BlockManager.blocks.findIndex(
          (h) => h.holder === s.holder,
        ));
      const a = this.Editor.BlockManager.lastBlock.holder.querySelector(
        ...
        c = t - l,
        d = t + l;
      return { index: r, leftPos: c, rightPos: d };
    }
    ...
    trySelectNextBlock(e) {
      ...
      for (
        e > this.stackOfSelected[o - 1]
          ? (f = () => e > this.stackOfSelected[g])
          : (f = () => e < this.stackOfSelected[g]);
        f();
      )
        (this.rectCrossesBlocks &&
          this.Editor.BlockSelection.unSelectBlockByIndex(
            this.stackOfSelected[g],
          ),
  ...
  class la extends E {
      ...
      return new Promise((t) => {
        ...
        if (e.length === 0) i.insert();
          ...
          const s = e.map(({ type: r, data: a, tunes: l, id: c }) => {
            ...
            let d;
            try {
              d = i.composeBlock({ id: c, tool: r, data: a, tunes: l });
            } catch (h) {
    ...
    composeStubDataForTool(e, t, o) {
      ...
      return { savedData: { id: o, type: e, data: t }, title: s };
    }
  }
  class ca extends E {
    async save() {
      ...
      try {
        ...
        const s = await Promise.all(i),
          r = await dt(s, (a) => t.blockTools.get(a).sanitizeConfig);
    ...
    makeOutput(e) {
      const t = [];
      return (
        e.forEach(({ id: o, tool: i, data: s, tunes: r, isValid: a }) => {
          if (!a) {
          ...
          const l = { id: o, type: i, data: s, ...(!V(r) && { tunes: r }) };
          t.push(l);
        }),
        { time: +new Date(), blocks: t, version: "2.31.1" }
      );
    }
  }
  (function () {
  ...
  class go {
    ...
    render() {
      return (
        ...
        (this.nodes.button.innerHTML = Xi),
        this.nodes.button
      );
    }
    surround() {
  ...
  class mo {
    ...
    render() {
      return (
        ...
        (this.nodes.button.innerHTML = zo),
        this.nodes.button
      );
    }
    renderActions() {
    ...
    checkState() {
      ...
      if (e) {
        ((this.nodes.button.innerHTML = Gi),
          ...
          return (
            (h = d.toolbox) == null ||
              h.forEach((p) => {
                c.push({
                  icon: p.icon,
                  title: H.t(W.toolNames, p.title),
                  name: d.name,
                  closeOnActivate: !0,
                  onActivate: async () => {
                    const g = await this.blocksAPI.convert(
                      t.id,
                      d.name,
                      p.data,
                    );
  ...
  class Nn {
    ...
    make() {
      const e = u.make("div", this.CSS.wrapper),
        ...
        i = u.make("div", this.CSS.title, { textContent: this.title }),
        s = u.make("div", this.CSS.subtitle, { textContent: this.subtitle });
      return (
        (e.innerHTML = t),
        o.appendChild(i),
        o.appendChild(s),
  ...
  Nn.isReadOnlySupported = !0;
  class ha extends xt {
    constructor() {
      (super(...arguments), (this.type = ce.Inline));
    }
    get title() {
    ...
    get isReadOnlySupported() {
      return this.constructable[He.IsReadOnlySupported] ?? !1;
    }
  }
  class pa extends xt {
    constructor() {
      (super(...arguments), (this.type = ce.Tune));
    }
    create(e, t) {
  ...
  var fa = Object.defineProperty,
    ...
    Rn = (n, e, t, o) => {
      for (
        var i = o > 1 ? void 0 : o ? ga(e, t) : e, s = n.length - 1, r;
        s >= 0;
        s--
      )
        (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
      return (o && i && fa(e, t, i), i);
    };
  class bo extends xt {
    constructor() {
      (super(...arguments),
        (this.type = ce.Block),
        (this.inlineTools = new F()),
        (this.tunes = new F()));
    }
    create(e, t, o) {
      return new this.constructable({
    ...
    get isReadOnlySupported() {
      return this.constructable[ve.IsReadOnlySupported] === !0;
    }
    get isLineBreaksEnabled() {
      return this.constructable[ve.IsEnabledLineBreaks];
    }
    get toolbox() {
      const e = this.constructable[ve.Toolbox],
        t = this.config[je.Toolbox];
      if (!V(e) && t !== !1)
        return t
          ? Array.isArray(e)
            ? Array.isArray(t)
    ...
    get conversionConfig() {
      return this.constructable[ve.ConversionConfig];
    }
    get enabledInlineTools() {
      return this.config[je.EnabledInlineTools] || !1;
    }
    get enabledBlockTunes() {
      return this.config[je.EnabledBlockTunes];
    }
    get pasteConfig() {
      return this.constructable[ve.PasteConfig] ?? {};
    }
    get sanitizeConfig() {
      ...
      for (const i in e)
        if (Object.prototype.hasOwnProperty.call(e, i)) {
          const s = e[i];
          N(s) ? (o[i] = Object.assign({}, t, s)) : (o[i] = s);
        }
      return o;
    }
  ...
  (Rn([fe], bo.prototype, "sanitizeConfig", 1),
    Rn([fe], bo.prototype, "baseSanitizeConfig", 1));
  class ma {
    constructor(e, t, o) {
  ...
  var ba = Object.defineProperty,
    ...
    ka = (n, e, t, o) => {
      for (
        var i = o > 1 ? void 0 : o ? va(e, t) : e, s = n.length - 1, r;
        s >= 0;
        s--
      )
        (r = n[s]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  class Hn extends E {
    constructor() {
      (super(...arguments),
        (this.stubTool = "stub"),
        (this.toolsAvailable = new F()),
        (this.toolsUnavailable = new F()));
    }
    get available() {
    ...
    async prepare() {
      if (
        (this.validateTools(),
        (this.config.tools = nt({}, this.internalTools, this.config.tools)),
        !Object.prototype.hasOwnProperty.call(this.config, "tools") ||
          Object.keys(this.config.tools).length === 0)
      )
        throw Error("Can't start without tools");
      const e = this.prepareConfig();
      this.factory = new ma(e, this.config, this.Editor.API);
    ...
    get internalTools() {
      return {
        convertTo: { class: Pn, isInternal: !0 },
        link: { class: mo, isInternal: !0 },
        bold: { class: fo, isInternal: !0 },
        italic: { class: go, isInternal: !0 },
        paragraph: { class: po, inlineToolbar: !0, isInternal: !0 },
        stub: { class: Nn, isInternal: !0 },
        moveUp: { class: jn, isInternal: !0 },
        delete: { class: Fn, isInternal: !0 },
        moveDown: { class: Dn, isInternal: !0 },
      };
    }
...
`;
  class wa extends E {
    constructor() {
      (super(...arguments),
        ...
        (this.resizeDebouncer = Bo(() => {
          this.windowResize();
        }, 200)),
        (this.selectionChangeDebounced = Bo(() => {
    ...
    get someFlipperButtonFocused() {
      return this.Editor.Toolbar.toolbox.hasFocus()
        ...
        : Object.entries(this.Editor)
            .filter(([e, t]) => t.flipper instanceof ae)
    ...
    setIsMobile() {
      const e = window.innerWidth < Co;
      (e !== this.isMobile &&
        this.eventsDispatcher.emit(xe, { isEnabled: this.isMobile }),
        (this.isMobile = e));
    }
    make() {
      ((this.nodes.holder = u.getHolder(this.config.holder)),
        (this.nodes.wrapper = u.make("div", [
          this.CSS.editorWrapper,
          ...(this.isRtl ? [this.CSS.editorRtlFix] : []),
        ])),
        (this.nodes.redactor = u.make("div", this.CSS.editorZone)),
    ...
    loadStyles() {
      ...
      if (u.get(e)) return;
      const t = u.make("style", null, { id: e, textContent: ya.toString() });
      (this.config.style &&
        !V(this.config.style) &&
    ...
    processBottomZoneClick(e) {
      ...
      if (
        ...
        ((!a.lastBlock.tool.isDefault || !a.lastBlock.isEmpty) &&
          a.insertAtEnd(),
          l.setToTheLastBlock(),
    ...
    selectionChanged() {
      ...
      ((i === null ||
        i.closest(`.${b.CSS.editorWrapper}`) !== this.nodes.wrapper) &&
  ...
  const Ea = {
    ...
    BlockSelection: ea,
    Caret: et,
    CrossBlockSelection: ta,
    DragNDrop: oa,
    ModificationsObserver: sa,
    Paste: ra,
    ReadOnly: aa,
    RectangleSelection: Ie,
    Renderer: la,
    Saver: ca,
    Tools: Hn,
    UI: wa,
  ...
  class xa {
    ...
    set configuration(e) {
      var o, i;
      (N(e) ? (this.config = { ...e }) : (this.config = { holder: e }),
        st(!!this.config.holderId, "config.holderId", "config.holder"),
        ...
        this.config.logLevel || (this.config.logLevel = ko.VERBOSE),
        Vn(this.config.logLevel),
        st(
      ...
      const t = { type: this.config.defaultBlock, data: {} };
      ((this.config.placeholder = this.config.placeholder || !1),
        ...
        (o = this.config.i18n) != null &&
          o.messages &&
          H.setDictionary(this.config.i18n.messages),
        ...
        (t, o) =>
          t.then(async () => {
            try {
              ...
              if (i instanceof Oo) throw new Error(i.message);
